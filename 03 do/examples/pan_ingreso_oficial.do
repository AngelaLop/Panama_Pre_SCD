...
* Kiyomi Cadena 
* Stata 12
* Comments: Replicar el ingreso oficial
*-----------------------------------------------------------------------------*
clear
clear matrix
set more off
...
local yearlist "02 03 04 05 06 09 10 11"
*local yearlist "06"
...
if year == 2006 | year == 2005 | year == 2004 |year == 2003 | year == 2002{
	gen p424 = .
}
...
*--------------------------Create one Dataset----------------------------------*
use pan_02, clear
foreach year in 03 04 05 06 09 10 11{
...
save pan_ingreso_oficial, replace
